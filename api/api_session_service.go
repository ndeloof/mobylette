...
// SessionApiService is a service that implents the logic for the SessionApiServicer
...
func (s *SessionApiService) Session(ctx context.Context) (ImplResponse, error) {
	// TODO - update Session with the required logic for this service method.
	// Add api_session_service.api to the .api-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("Session method not implemented")
}
