...
// SecretApiService is a service that implents the logic for the SecretApiServicer
...
func (s *SecretApiService) SecretCreate(ctx context.Context, body UNKNOWN_BASE_TYPE) (ImplResponse, error) {
	// TODO - update SecretCreate with the required logic for this service method.
	// Add api_secret_service.api to the .api-generator-ignore to avoid overwriting this service implementation when updating open api generation.
...
func (s *SecretApiService) SecretUpdate(ctx context.Context, id string, version int64, body SecretSpec) (ImplResponse, error) {
